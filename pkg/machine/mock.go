...
//go:generate go run go.uber.org/mock/mockgen -destination=./csmock/volume_service.go -package csmock github.com/cloudscale-ch/cloudscale-go-sdk/v6 VolumeService
